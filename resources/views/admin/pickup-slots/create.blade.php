...
<head>
    ...
    <title>Ajouter un créneau — Le Flash</title>
        ...
        <header class="topbar">
            ...
            <div>
                ...
                <div class="topbar-subtitle">
                    Ajoutez une nouvelle disponibilité de retrait.
                </div>
            </div>
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="card-subtitle">
                    Définissez la date, l'horaire et le nombre maximal de commandes.
                </div>


                <form
                    method="POST"
                    action="{{ route('admin.pickup-slots.store') }}"
                >
                    ...
                    <div class="form-grid">
                        ...
                        <div class="field">
                            ...
                            <input
                                ...
                                type="number"
                                min="1"
                                value="{{ old('max_orders', 5) }}"
                                required
                            >

                            <div class="hint">
                                Exemple : 5 signifie que 5 commandes maximum pourront utiliser ce créneau.
                            </div>
                        ...
                        <div class="field">
                            ...
                            <div class="hint">
                                Un créneau inactif ne sera pas proposé au client.
                            </div>
